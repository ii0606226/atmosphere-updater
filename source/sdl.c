...
void loadTextures()
{
	...
	imageLoad(&appTextures.patch_icon, "romfs:/patch_icon.png");
...
void destroyTextures()
{
	...
	SDL_DestroyTexture(appTextures.patch_icon);
...
void sdlInit()
{
	...
	main_window = SDL_CreateWindow("atmosphere-updater", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, SCREEN_W, SCREEN_H, SDL_WINDOW_SHOWN);
